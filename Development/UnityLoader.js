...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Web Orbic.data';
    var REMOTE_PACKAGE_BASE = 'Web Orbic.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3536958;
      var PACKAGE_UUID = 'a1af6f83-6a8c-49a3-a10e-1ae9fdade79f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 520860, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(520860, 520881, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(520881, 533577, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(533577, 2634361, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2634361, 3509333, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3509333, 3536958, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Web Orbic.data');

    };
    Module['addRunDependency']('datafile_Web Orbic.data');
